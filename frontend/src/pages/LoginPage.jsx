  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#07080f] relative overflow-hidden">
      ...
      <div className="absolute w-[500px] h-[500px] rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(88,28,135,0.12) 0%, transparent 70%)", top: "-10%", left: "-10%" }} />
      <div className="absolute w-[400px] h-[400px] rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(15,118,110,0.1) 0%, transparent 70%)", bottom: "-5%", right: "-5%" }} />
      ...
      <div className="fade-in relative z-10 glass-strong rounded-3xl w-full max-w-md p-8 shadow-2xl">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <span className="text-white text-xl font-semibold tracking-widest" style={{ letterSpacing: "0.15em" }}>
            VOID CHAT
          </span>
        </div>

        <h1 className="text-xl font-semibold text-white/90 text-center mb-1">Welcome back</h1>
        <p className="text-white/30 text-sm text-center mb-7">Sign in to re-enter the void</p>
        ...
        <p className="text-center text-white/25 text-sm mt-6">
          No account?{" "}
          <Link to="/register" className="text-violet-400/70 hover:text-violet-300 transition">
            Create one
          </Link>
        </p>
      </div>
